...
try:
    ...
    try:
        ...
        DANBOORU_REFERENCE_SHEET_BALANCE_TAGS = _danbooru_module.DANBOORU_REFERENCE_SHEET_BALANCE_TAGS
...
_自然风光光影扩展标签 = {
    ("光影氛围", "光线类型"): [
        ...
        "海雾日出丁达尔光", "峡谷雨后丁达尔光", "古建筑门洞光束", "厂房高窗体积光", "舞台烟雾斜射光",
        "水下洞穴天窗光", "沙漠尘雾低角度光", "雪谷云隙体积光", "温室水汽穿透光", "夜林月光丁达尔光",
    ],
    ("光影氛围", "大气光学"): [
        ...
        "暮光射线", "云底散射光带", "海面蒸腾雾光", "冰雾棱镜光", "火山灰光幕",
        "瀑布虹彩散射", "森林湿气光路", "城市峡谷气溶胶光",
    ],
    ("光影氛围", "光源互动"): [
        "教堂彩窗丁达尔光", "废墟拱门丁达尔光", "海蚀洞丁达尔光", "雪林低角度光束", "竹林晨雾光束",
        "岩洞水汽光柱", "尘埃逆光颗粒层", "雨巷路灯体积光", "湖面反射补光", "瀑布侧逆光水雾",
        "极光雪地漫反射", "沙丘脊线掠射光", "云影落在山谷", "建筑缝隙切光", "树洞入口柔光",
        "月光穿林雾束", "日出穿云光扇", "风暴边缘银光", "海底天窗光柱", "温室叶影透光",
    ],
    ("光影氛围", "天气氛围"): [
    ...
    ("场景背景", "天空天象"): [
        "积雨云砧状云顶", "乳状云天幕", "荚状云群", "鱼鳞云层", "晨曦卷云",
        "暮色层积云", "星轨拱门", "银河核心天幕", "黄道光夜空", "流星雨天幕",
        "彗星尾迹", "月食红月", "日食光环", "极光帷幕", "雷暴云墙",
        "远海龙卷云", "云海日出天际", "云层地面投影", "高空冰晶云", "雨幡垂落",
    ],
    ("场景背景", "地质奇观"): [
        "玄武岩柱群", "红色砂岩峡谷", "石灰岩溶洞", "冰碛平原", "冰川U形谷",
        "海蚀柱群", "潮间带岩池", "泥火山地貌", "间歇泉盆地", "硫磺温泉台地",
        "风蚀蘑菇岩", "砾石冲积扇", "蛇曲河谷", "火山熔岩台地", "石灰华梯田",
        "黑色玄武岩海岸", "红土高原", "白垩悬崖", "冰川末端湖", "地下盐洞",
    ],
    ("场景背景", "植被生态"): [
        "高山杜鹃坡", "银杏林道", "胡杨林", "椰林海岸", "海岸松林",
        "草甸野花带", "苔原地衣群", "芒草山坡", "荷塘湿地", "睡莲湖面",
        "红叶溪谷", "竹林溪涧", "古藤雨林", "猴面包树草原", "樱花林道",
        "梅林雪景", "枫林晨雾", "向日葵坡地", "野生蕨类层", "白桦湿地",
    ],
    ("场景背景", "建筑风景"): [
        "山谷修道院", "悬崖石屋村", "海边白色小镇", "水上木屋聚落", "梯田山村",
        "雪山寺院", "沙漠土坯城", "古罗马输水桥", "哥特教堂远景", "现代山地博物馆",
        "玻璃温室建筑", "湖畔木屋", "森林观景塔", "火山观测站", "极地科研建筑",
        "海岸防波堤灯塔", "废弃工业厂区远景", "铁路高架穿谷", "跨海大桥远景", "山体隧道入口",
    ],
    ("场景背景", "人文风景"): [
        "晨雾渔港", "梯田古村", "雪山牧场营地", "海岛彩色渔村", "河谷葡萄园庄园",
        "荒漠驿站", "森林铁路小站", "湖畔露营地", "山脊风力电场", "峡谷悬索桥",
        "雨季水上集市", "高原寺院村落", "火山脚下温泉镇", "海岸盐田", "秋收丘陵农场",
    ],
    ("场景背景", "天文地景"): [
        "银河下的盐湖", "星轨环绕雪山", "极光映照冰湖", "月食下的荒原", "流星雨海岸",
        "彗星掠过山谷", "日食光环沙漠", "黄道光高原", "红月火山口", "星云映照海面",
        "深空观测站山巅", "月光云海山脊",
    ],
    ("构图视角", "风景构图"): [
    ...
    ("构图视角", "单帧稳定"): [
        "单帧决定性瞬间", "单一连续画面", "主体仅出现一次", "单人单脸构图", "双人同帧站位清楚",
        "群像同帧层级清楚", "每人独立脸部", "固定镜头时刻", "动作峰值定格", "前因后果同框暗示",
        "身份一致性构图", "镜面主体边界清楚", "单一视觉焦点", "主次人物层级明确", "完整头肩轮廓",
        "单一拍摄视点", "单一动作相位", "单人完整身体轮廓", "脸部唯一清晰焦点", "前后景身份连续",
        "人物与反射主次分离", "前景只作尺度参照", "背景保持环境层次", "双人独立身体轮廓", "群像独立身份站位",
    ],
    ("构图视角", "叙事构图"): [
        "道具线索前景", "动作峰值中景", "事件来源背景", "视线引导至画外", "门框建立空间边界",
        "窗格建立光线方向", "道路引向事件焦点", "环境痕迹暗示前因", "衣料余势暗示动作", "光线落点强化转折",
        "单一事件视觉主线", "开放结尾留白", "主体与场景因果构图", "固定焦平面叙事", "决定性瞬间摄影",
    ],
    ("技术画质", "环境材质"): [
