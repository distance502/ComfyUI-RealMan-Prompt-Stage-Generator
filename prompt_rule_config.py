...
多视图一致性附加负面词_EN = [
    ...
    "incorrect front side back order",
    "side view not at 90 degrees",
    "extra full-body view",
    "unequal column widths",
    "unequal view sizes",
    "inconsistent character height across views",
    "misaligned head line",
    "misaligned ground baseline",
    "inconsistent camera height",
    "perspective foreshortening",
    "wide-angle perspective distortion",
    "overlapping primary views",
    "cropped full body",
    "cropped head",
    "cropped feet",
    "support detail panel compressing primary views",
    "identity drift across views",
    "wardrobe drift across views",
    "body proportion drift across views",
    "hairstyle drift across views",
